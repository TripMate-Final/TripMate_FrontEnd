  ...
  <div>
    <b-card no-body class="overflow-hidden">
      <b-row>
        ...
        <b-col md="8">
          <b-card-body>
            <b-button-close v-if="selectedDay != 0" @click="removeContent(`${day}`,`${index}`)"></b-button-close>
...
export default {
  ...
  methods:{
    ...
    removeContent(day,index){
      this["mapStore/deletePlan"]({day,index})
    }
